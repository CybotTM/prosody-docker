...
.PHONY: version_major _version_major version_minor _version_minor version_fix _version_fix version_build _version_build echo_version commit_version
...
_version_build:
	...
	git commit VERSION -nm"Build $$(( ${BUILD} + 1 ))"
